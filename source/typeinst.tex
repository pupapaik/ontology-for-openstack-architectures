...
\usepackage{url}
%\urldef{\mailsa}\path|{ales.komarek, jakub.pavlik.7}@uhk.cz|    
...
\titlerunning{High Level Models for IaaS Cloud Architectures}
...
%
%\author{Ales Komarek\and Jakub Pavlik}
\author{Ales Komarek\and Jakub Pavlik\and Vladimir Sobeslav}
%
%\authorrunning{High Level Models for IaaS Cloud Architectures}
